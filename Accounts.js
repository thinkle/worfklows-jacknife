...
var defaultCreateAccountSubject = "Account Info";
var defaultCreateAccountTemplate = "This email is to inform you that a new account has been created for <<username>> with the initial password <<password>>.";
...
function createAccount (params) {
    ...
    var user = params.fields ? params.fields : {}
